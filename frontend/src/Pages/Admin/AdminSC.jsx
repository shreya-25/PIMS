    ...
    <div className="admin-container">
      ...
      <div className="top-menu">
        ...
        <span className="menu-item" onClick={() => handleNavigation('/AdminUR')}>
          ...
          <span className="menu-item active"onClick={() => handleNavigation('/AdminSC')} >
            Search Cases
          </span>
      ...
      <h1 className="searchlead-title">SEARCH CASES</h1>
      </div>
        ...
        <tr key={`static-${index}`}>
          ...
          <td>
            ...
            >
              ...
              <option value="Assigned Case Manager">Assigned Case Manager</option>
              <option value="Assigned Officer">Assigned Officers</option>
        ...
        <tr key={`dynamic-${index}`}>
          ...
          <td>
            ...
            >
              ...
              <option value="Keyword">Keyword</option>
              <option value="Assigned Case Manager">Assigned Case Manager</option>
              <option value="Assigned Officers">Assigned Officer</option>
              <option value="Completed Date">Completed Date</option>
            </select>
          </td>
          <td>
...
<p className="results-title">Matching Cases</p>
