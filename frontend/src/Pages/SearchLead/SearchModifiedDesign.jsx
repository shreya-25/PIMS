          ...
          <div className="main-content-searchlead">
            <div className="search-page-bar">
              <div className="search-bar-page">
                ...
                <button className="professional-search-btn" onClick={handleSearch}>
                ...
                {leadsData.length > 0 && (
                  <div className="results-summary">
                    <span className="results-stat">
                      <span className="results-count">{uniqueCasesCount}</span> Cases
                    </span>
                    <span className="results-separator">|</span>
                    <span className="results-stat">
                      <span className="results-count">{totalLeadsCount}</span> Leads
                    </span>
                  </div>
                )}
              </div>
