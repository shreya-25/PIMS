...
//               <div className="dropdown-list">
//                 {emailList.map((email, index) => (
//                   <div key={index} className="dropdown-item" onClick={() => handleEmailClick(index)}>
//                     {email}
//                   </div>
//                 ))}
//               </div>
...
//               <div className="dropdown-list">
//                 {chatList.map((chat, index) => (
//                   <div key={index} className="dropdown-item" onClick={() => handleChatClick(index)}>
//                     {chat}
//                   </div>
//                 ))}
//               </div>
...
//           <i className="fa-solid fa-user"></i>
//           {/* <img
//                 src={`${process.env.PUBLIC_URL}/Materials/user-white.png`}
//                 alt="Home"
//                 className="icon-img"
//               /> */}
