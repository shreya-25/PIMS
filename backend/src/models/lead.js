...
const leadSchema = new mongoose.Schema(
   ...
   primaryInvestigator: {
      ...
      validate: {
        ...
        leadStatus: { type: String, required: true, enum: ["Created", "Assigned", "Accepted","To Reassign","Rejected", "In Review", "Approved","Returned", "Completed", "Closed", "Reopened" ], default: "Assigned"},
        dueDate: { type: Date },
