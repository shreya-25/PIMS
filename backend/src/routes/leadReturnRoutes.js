...
const { createLeadReturn, getLeadsReturnByOfficer,  updateLRStatusToPending, updateLRStatusToSubmitted } = require("../controller/leadReturnController");
...
router.put("/set-lrstatus-submitted", verifyToken, updateLRStatusToSubmitted);
